...
In the midst of this crisis of the field, L.L. Thurstone in his 1927 paper, A Law of Comparative Judgement @thurstone2017law proposed a new way to perform psychological measurement. He argued that while we as humans may not have an absolute scale, we possess a high sensitive comparison mechanism to compare any two stimuli via a relative scale.
