...
```bibtex
@article{vivek2026from-scales-to-spaces-episode1,
author = {Vivek Anand},
title  = {From Scales to Spaces, Ep. 1: Building the Psychological Ruler},
year   = {2026},
url    = {https://vivek-anand.xyz/blog/from-scales-to-spaces-episode-1-building-the-psychological-ruler/}
}
```
