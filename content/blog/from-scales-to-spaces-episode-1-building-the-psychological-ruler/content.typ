This is episode 1 in series of blog posts that seek to explain how mental representations became a powerful tool in psychology and cognitive neuroscience from the early 20th century to the present day. This episode focusses on the dire straits the field found itself in the early 20th century and the novel quantitative paradigm that allowed the field to objectively quantify psychological phenomena (perhaps for the first time!).
